...
export { AssetScheduler, AssetTask } from './loaders/AssetScheduler.js';
...
export { CapabilitiesReport } from './core/CapabilitiesReport.js';
export { DiagnosticLevel, Diagnostics } from './core/Diagnostics.js';
...
export { default as RenderGraph } from './renderers/common/RenderGraph.js';
export { createCanvasElement, setConsoleFunction, getConsoleFunction, log, warn, error, warnOnce } from './utils.js';
export * from './constants.js';
export * from './Four.Legacy.js';

if ( typeof __FOUR_DEVTOOLS__ !== 'undefined' ) {

	__FOUR_DEVTOOLS__.dispatchEvent( new CustomEvent( 'register', { detail: {
		revision: REVISION,
	} } ) );
...
if ( typeof window !== 'undefined' ) {
	...
	if ( window.__FOUR__ ) {
		...
		warn( 'WARNING: Multiple instances of 4.js being imported.' );

	} else {

		window.__FOUR__ = REVISION;
