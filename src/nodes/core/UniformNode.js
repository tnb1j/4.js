...
class UniformNode extends InputNode {
	 ...
	 *
	 * @param {any} value - The value of this node. Usually a JS primitive or 4.js object (vector, matrix, color, texture).
 ...
 * @tsl
 * @function
 * @param {any|string} value - The value of this uniform or your type. Usually a JS primitive or 4.js object (vector, matrix, color, texture).
