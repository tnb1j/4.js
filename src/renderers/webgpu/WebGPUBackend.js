...
class WebGPUBackend extends Backend {
	...
	async init( renderer ) {
		...
		if ( parameters.device === undefined ) {
			...
			if ( adapter === null ) {
				...
				throw new Error( 'FOUR.WebGPUBackend: Unable to create WebGPU adapter.' );
	...
	get context() {
		...
		if ( context === undefined ) {
			...
			if ( 'setAttribute' in canvasTarget.domElement ) canvasTarget.domElement.setAttribute( 'data-engine', `4.js r${ REVISION } webgpu` );
