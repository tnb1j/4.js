...
class WebGPUPipelineUtils {
	...
	createRenderPipeline( renderObject, promises ) {
		...
		if ( renderDepth === true || renderStencil === true ) {
			...
			if ( material.polygonOffset === true && ( primitiveState.topology === GPUPrimitiveTopology.TriangleList ) ) {
				...
				depthStencil.depthBiasClamp = 0; // 4.js does not provide an API to configure this value
	 ...
	 *
	 * @private
	 * @param {number} blend - The blend factor as a 4.js constant.
	 ...
	 *
	 * @private
	 * @param {number} op - A 4.js constant defining the stencil operation.
	 ...
	 *
	 * @private
	 * @param {number} blendEquation - A 4.js constant defining the blend equation.
