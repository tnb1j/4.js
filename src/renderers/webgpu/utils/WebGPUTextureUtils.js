...
class WebGPUTextureUtils {
	...
	createTexture( texture, options = {} ) {
		...
		if ( textureData.initialized ) {
			...
			throw new Error( 'FOUR.WebGPUTextureUtils: Texture already initialized.' );
	...
	/**
	 * Converts the 4.js uv wrapping constants to GPU address mode constants.
	 *
	 * @private
	 * @param {number} value - The 4.js constant defining a uv wrapping mode.
	...
	/**
	 * Converts the 4.js filter constants to GPU filter constants.
	 *
	 * @private
	 * @param {number} value - The 4.js constant defining a filter mode.
	...
	/**
	 * Converts the 4.js filter constants to a GPU mipmap filter constant.
	 * Unlike `_convertFilterMode`, this extracts the between-mip-level filtering
	 * axis from the combined 4.js constant rather than the within-level axis.
	 *
	 * @private
	 * @param {number} value - The 4.js constant defining a filter mode.
