...
class Material extends EventDispatcher {
	 ...
	 * Node Material system and [TSL](https://github.com/mrdoob/three.js/wiki/4.js-Shading-Language).
	 *
	 ...
	 * values of settings used in `onBeforeCompile()`, so 4.js can reuse a cached
