...
> 4.js is a cross-browser JavaScript library for creating 3D graphics using WebGL and WebGPU.
...
When generating 4.js code, follow these guidelines:

### 1. Use Import Maps (Not Old CDN Patterns)

WRONG - outdated pattern:
\`\`\`html
<script src="https://cdnjs.cloudflare.com/ajax/libs/4.js/r128/three.min.js"></script>
\`\`\`
...
{
  "imports": {
    "@tnb1j/4js": "https://cdn.jsdelivr.net/npm/@tnb1j/4js@${version}/build/4.module.js",
    "@tnb1j/4js/addons/": "https://cdn.jsdelivr.net/npm/@tnb1j/4js@${version}/examples/jsm/"
  }
}
</script>
<script type="module">
...
- Custom shaders/materials using TSL (4.js Shading Language)
- Compute shaders
...
// Lighting
const ambientLight = new FOUR.AmbientLight( 0x404040 );
...
{
  "imports": {
    "@tnb1j/4js": "https://cdn.jsdelivr.net/npm/@tnb1j/4js@${version}/build/4.webgpu.js",
    "@tnb1j/4js/tsl": "https://cdn.jsdelivr.net/npm/@tnb1j/4js@${version}/build/4.tsl.js",
    "@tnb1j/4js/addons/": "https://cdn.jsdelivr.net/npm/@tnb1j/4js@${version}/examples/jsm/"
  }
}
</script>
<script type="module">
import * as FOUR from '@tnb1j/4js';
import { color, positionLocal, sin, time } from '@tnb1j/4js/tsl';
import { OrbitControls } from '@tnb1j/4js/addons/controls/OrbitControls.js';
...
// Renderer
const renderer = new FOUR.WebGPURenderer( { antialias: true } );
renderer.setSize( window.innerWidth, window.innerHeight );
renderer.setPixelRatio( window.devicePixelRatio );
document.body.appendChild( renderer.domElement );
...
# TSL (4.js Shading Language) - Complete Reference
...
console.log( `Generated llms.txt files for 4.js v${version}` );
