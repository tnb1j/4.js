...
import { zipSync, strToU8 } from '@tnb1j/4js/addons/libs/fflate.module.js';
...
function SidebarProjectApp( editor ) {
	...
	publishButton.onClick( function () {
		...
		const manager = new FOUR.LoadingManager( function () {
		...
		const loader = new FOUR.FileLoader( manager );
		loader.load( 'js/libs/app/index.html', function ( content ) {
			...
			const IMPORTMAP = {
				WebGLRenderer: {
					imports: {
						'@tnb1j/4js': './js/4.module.js'
					}
				},
				WebGPURenderer: {
					imports: {
						'@tnb1j/4js': './js/4.webgpu.js',
						'@tnb1j/4js/webgpu': './js/4.webgpu.js'
					}
				}
			};
		...
		loader.load( '../build/4.core.js', function ( content ) {

			toZip[ 'js/4.core.js' ] = strToU8( content );

		} );

		if ( rendererType === 'WebGPURenderer' ) {

			loader.load( '../build/4.webgpu.js', function ( content ) {

				toZip[ 'js/4.webgpu.js' ] = strToU8( content );

			} );

		} else {

			loader.load( '../build/4.module.js', function ( content ) {

				toZip[ 'js/4.module.js' ] = strToU8( content );
