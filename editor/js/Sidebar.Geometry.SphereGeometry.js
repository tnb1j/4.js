...
function GeometryParametersPanel( editor, object ) {
	...
	const phiStart = new UINumber( parameters.phiStart * FOUR.MathUtils.RAD2DEG ).setUnit( '°' ).setStep( 10 ).onChange( update );
	...
	const phiLength = new UINumber( parameters.phiLength * FOUR.MathUtils.RAD2DEG ).setUnit( '°' ).setStep( 10 ).onChange( update );
	...
	const thetaStart = new UINumber( parameters.thetaStart * FOUR.MathUtils.RAD2DEG ).setUnit( '°' ).setStep( 10 ).onChange( update );
	...
	const thetaLength = new UINumber( parameters.thetaLength * FOUR.MathUtils.RAD2DEG ).setUnit( '°' ).setStep( 10 ).onChange( update );
	...
	function refreshUI() {
		...
		phiStart.setValue( parameters.phiStart * FOUR.MathUtils.RAD2DEG );
		phiLength.setValue( parameters.phiLength * FOUR.MathUtils.RAD2DEG );
		thetaStart.setValue( parameters.thetaStart * FOUR.MathUtils.RAD2DEG );
		thetaLength.setValue( parameters.thetaLength * FOUR.MathUtils.RAD2DEG );
	...
	function update() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new FOUR.SphereGeometry(
			radius.getValue(),
			widthSegments.getValue(),
			heightSegments.getValue(),
			phiStart.getValue() * FOUR.MathUtils.DEG2RAD,
			phiLength.getValue() * FOUR.MathUtils.DEG2RAD,
			thetaStart.getValue() * FOUR.MathUtils.DEG2RAD,
			thetaLength.getValue() * FOUR.MathUtils.DEG2RAD
		) ) );
