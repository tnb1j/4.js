...
import buildFourDefs from './libs/tern-fourjs/build-defs.js';
...
function Script( editor ) {
	...
	// The 4.js API definitions are built lazily from the JSDoc in the library
	...
	server.server.defs.push( buildFourDefs( source ) );
			...
			console.warn( 'Script: Failed to build 4.js autocomplete defs.', error );
