...
import { WebGPURenderer } from '@fourjs/core/webgpu';
...
function SidebarProjectRenderer( editor ) {
	...
	async function createRenderer() {
		...
		if ( rendererType === 'WebGPURenderer' ) {
			...
			currentRenderer = new FOUR.WebGLRenderer( { antialias: antialias, reversedDepthBuffer: true } );
	...
	signals.editorCleared.add( function () {
		...
		currentRenderer.shadowMap.type = FOUR.PCFShadowMap;
		currentRenderer.toneMapping = FOUR.NeutralToneMapping;
