...
import { InteractiveGroup } from '@fourjs/core/addons/interactive/InteractiveGroup.js';
	...
	constructor( editor, controls ) {
		...
		const onSessionStarted = async ( session ) => {
			...
			if ( controllers === null ) {
				...
				geometry.setAttribute( 'position', new FOUR.Float32BufferAttribute( [ 0, 0, 0, 0, 0, - 5 ], 3 ) );

				const line = new FOUR.Line( geometry );
