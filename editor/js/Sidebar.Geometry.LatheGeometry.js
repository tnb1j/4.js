...
import { UIPoints2 } from './libs/ui.four.js';
...
function GeometryParametersPanel( editor, object ) {
	...
	const phiStart = new UINumber( parameters.phiStart * FOUR.MathUtils.RAD2DEG ).onChange( update );
	...
	const phiLength = new UINumber( parameters.phiLength * FOUR.MathUtils.RAD2DEG ).onChange( update );
	...
	function update() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new FOUR.LatheGeometry(
			points.getValue(),
			segments.getValue(),
