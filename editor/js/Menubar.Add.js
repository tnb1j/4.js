...
function MenubarAdd( editor ) {
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.BoxGeometry( 1, 1, 1, 1, 1, 1 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Box';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.CircleGeometry( 1, 32, 0, Math.PI * 2 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Circle';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.CylinderGeometry( 1, 1, 1, 32, 1, false, 0, Math.PI * 2 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Cylinder';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.DodecahedronGeometry( 1, 0 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.IcosahedronGeometry( 1, 0 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.LatheGeometry();
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial( { side: FOUR.DoubleSide } ) );
		mesh.name = 'Lathe';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.OctahedronGeometry( 1, 0 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.PlaneGeometry( 1, 1, 1, 1 );
		const material = new FOUR.MeshStandardMaterial();
		const mesh = new FOUR.Mesh( geometry, material );
		mesh.name = 'Plane';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.RingGeometry( 0.5, 1, 32, 1, 0, Math.PI * 2 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Ring';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.SphereGeometry( 1, 32, 16, 0, Math.PI * 2, 0, Math.PI );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Sphere';
	...
	option.onClick( function () {
		...
		const sprite = new FOUR.Sprite( new FOUR.SpriteMaterial() );
		sprite.name = 'Sprite';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.TetrahedronGeometry( 1, 0 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.TorusGeometry( 1, 0.4, 12, 48, Math.PI * 2 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Torus';
	...
	option.onClick( function () {
		...
		const geometry = new FOUR.TorusKnotGeometry( 1, 0.4, 64, 8, 2, 3 );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'TorusKnot';
	...
	option.onClick( function () {
		...
		const path = new FOUR.CatmullRomCurve3( [
			new FOUR.Vector3( 2, 2, - 2 ),
			new FOUR.Vector3( 2, - 2, - 0.6666666666666667 ),
			new FOUR.Vector3( - 2, - 2, 0.6666666666666667 ),
			new FOUR.Vector3( - 2, 2, 2 )
		] );

		const geometry = new FOUR.TubeGeometry( path, 64, 1, 8, false );
		const mesh = new FOUR.Mesh( geometry, new FOUR.MeshStandardMaterial() );
		mesh.name = 'Tube';
	...
	option.onClick( function () {
		...
		const light = new FOUR.AmbientLight( color );
	...
	option.onClick( function () {
		...
		const light = new FOUR.DirectionalLight( color, intensity );
	...
	option.onClick( function () {
		...
		const light = new FOUR.PointLight( color, intensity, distance );
	...
	option.onClick( function () {
		...
		const light = new FOUR.SpotLight( color, intensity, distance, angle, penumbra );
	...
	option.onClick( function () {
		...
		const camera = new FOUR.OrthographicCamera( - aspect, aspect );
