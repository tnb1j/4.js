...
class TextureParametersDialog {
	...
	constructor( editor, texture ) {
		...
		this.mapping = new UISelect().setOptions( {
			[ FOUR.UVMapping ]: 'UV',
			[ FOUR.EquirectangularReflectionMapping ]: 'Equirectangular Reflection',
			[ FOUR.EquirectangularRefractionMapping ]: 'Equirectangular Refraction',
			[ FOUR.CubeReflectionMapping ]: 'Cube Reflection',
			[ FOUR.CubeRefractionMapping ]: 'Cube Refraction',
			[ FOUR.CubeUVReflectionMapping ]: 'CubeUV Reflection'
		...
		const wrapOptions = {
			[ FOUR.RepeatWrapping ]: 'Repeat',
			[ FOUR.ClampToEdgeWrapping ]: 'Clamp To Edge',
			[ FOUR.MirroredRepeatWrapping ]: 'Mirrored Repeat'
		};
		...
		this.minFilter = new UISelect().setOptions( {
			[ FOUR.NearestFilter ]: 'Nearest',
			[ FOUR.NearestMipmapNearestFilter ]: 'Nearest Mipmap Nearest',
			[ FOUR.NearestMipmapLinearFilter ]: 'Nearest Mipmap Linear',
			[ FOUR.LinearFilter ]: 'Linear',
			[ FOUR.LinearMipmapNearestFilter ]: 'Linear Mipmap Nearest',
			[ FOUR.LinearMipmapLinearFilter ]: 'Linear Mipmap Linear'
		...
		this.rotation = new UINumber( texture.rotation * FOUR.MathUtils.RAD2DEG ).setStep( 10 ).setNudge( 0.1 ).setUnit( '°' ).setWidth( '60px' ).onChange( updatePreview );
		...
		this.colorSpace = new UISelect().setOptions( {
			[ FOUR.NoColorSpace ]: 'No Color Space',
			[ FOUR.SRGBColorSpace ]: 'sRGB',
			[ FOUR.LinearSRGBColorSpace ]: 'Linear sRGB'
	...
	getCurrentParameters() {
		...
		return {
			...
			rotation: this.rotation.getValue() * FOUR.MathUtils.DEG2RAD,
