...
function SidebarObject( editor ) {
	...
	*/
	...
	const objectUUIDRenew = new UIButton( strings.getKey( 'sidebar/object/new' ) ).setMarginLeft( '7px' ).onClick( function () {
		...
		objectUUID.setValue( FOUR.MathUtils.generateUUID() );
	...
	function update() {
		...
		if ( object !== null ) {
			...
			const newPosition = new FOUR.Vector3( objectPositionX.getValue(), objectPositionY.getValue(), objectPositionZ.getValue() );
			...
			const newRotation = new FOUR.Euler( objectRotationX.getValue() * FOUR.MathUtils.DEG2RAD, objectRotationY.getValue() * FOUR.MathUtils.DEG2RAD, objectRotationZ.getValue() * FOUR.MathUtils.DEG2RAD );
			if ( new FOUR.Vector3().setFromEuler( object.rotation ).distanceTo( new FOUR.Vector3().setFromEuler( newRotation ) ) >= 0.01 ) {

				editor.execute( new SetRotationCommand( editor, object, newRotation ) );

			}

			const newScale = new FOUR.Vector3( objectScaleX.getValue(), objectScaleY.getValue(), objectScaleZ.getValue() );
	...
	function updateUI( object ) {
		...
		objectRotationX.setValue( object.rotation.x * FOUR.MathUtils.RAD2DEG );
		objectRotationY.setValue( object.rotation.y * FOUR.MathUtils.RAD2DEG );
		objectRotationZ.setValue( object.rotation.z * FOUR.MathUtils.RAD2DEG );
