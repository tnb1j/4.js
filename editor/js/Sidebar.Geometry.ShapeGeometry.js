...
function GeometryParametersPanel( editor, object ) {
	...
	function changeShape() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new FOUR.ShapeGeometry(
			parameters.shapes,
	...
	function toExtrude() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new FOUR.ExtrudeGeometry(
			parameters.shapes, {
