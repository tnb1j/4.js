...
import { FileLoader, PropertyBinding } from '@tnb1j/4js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		const { DRACOExporter } = await import( '@tnb1j/4js/addons/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		const { GLTFExporter } = await import( '@tnb1j/4js/addons/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		const { OBJExporter } = await import( '@tnb1j/4js/addons/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		const { PLYExporter } = await import( '@tnb1j/4js/addons/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		const { STLExporter } = await import( '@tnb1j/4js/addons/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		const { USDZExporter } = await import( '@tnb1j/4js/addons/exporters/USDZExporter.js' );
