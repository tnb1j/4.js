...
class EditorControls extends FOUR.EventDispatcher {
	...
	constructor( object ) {
		...
		var scope = this;
		var vector = new FOUR.Vector3();
		var delta = new FOUR.Vector3();
		var box = new FOUR.Box3();

		var STATE = { NONE: - 1, ROTATE: 0, ZOOM: 1, PAN: 2 };
		var state = STATE.NONE;

		var center = this.center;
		var normalMatrix = new FOUR.Matrix3();
		var pointer = new FOUR.Vector2();
		var pointerOld = new FOUR.Vector2();
		var spherical = new FOUR.Spherical();
		var sphere = new FOUR.Sphere();
		...
		var touches = [ new FOUR.Vector3(), new FOUR.Vector3(), new FOUR.Vector3() ];
		var prevTouches = [ new FOUR.Vector3(), new FOUR.Vector3(), new FOUR.Vector3() ];
