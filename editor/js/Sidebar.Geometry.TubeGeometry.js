...
function GeometryParametersPanel( editor, object ) {
	...
	function update() {
		...
		editor.execute( new SetGeometryCommand( editor, object, new FOUR.TubeGeometry(
			new FOUR.CatmullRomCurve3( points.getValue(), closed.getValue(), curveType.getValue(), tension.getValue() ),
