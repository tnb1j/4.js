...
async function main() {
	...
	const builds = {
		'4.core.js': buildInjection( await fs.readFile( 'build/4.core.js', 'utf8' ) ),
		'4.module.js': buildInjection( await fs.readFile( 'build/4.module.js', 'utf8' ) ),
		'4.webgpu.js': buildInjection( await fs.readFile( 'build/4.webgpu.js', 'utf8' ) )
	};
