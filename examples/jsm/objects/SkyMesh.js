...
import { Fn, float, vec2, vec3, acos, add, mul, clamp, cos, dot, exp, max, mix, modelViewProjection, normalize, positionWorld, pow, smoothstep, sub, varyingProperty, vec4, uniform, cameraPosition, fract, floor, sin, time, Loop, If } from '@fourjs/core/tsl';
 ...
 *
 * @augments Mesh
 * @four_import import { SkyMesh } from '@fourjs/core/addons/objects/SkyMesh.js';
 */
