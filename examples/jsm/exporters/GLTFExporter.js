 ...
 * ```
 *
 * @four_import import { GLTFExporter } from '@fourjs/core/addons/exporters/GLTFExporter.js';
 */
class GLTFExporter {
...
class GLTFWriter {
		...
		if ( mesh.morphTargetInfluences !== undefined && mesh.morphTargetInfluences.length > 0 ) {
			...
			for ( let i = 0; i < mesh.morphTargetInfluences.length; ++ i ) {
				...
				for ( const attributeName in geometry.morphAttributes ) {
					...
					// 4.js doesn't support TANGENT yet.
					...
					// 4.js morph attribute has absolute values while the one of glTF has relative values.
					//
	...
	async processNodeAsync( object ) {
		...
		// We don't export empty strings name because it represents no-name in 4.js.
