import { REVISION } from '@tnb1j/4js/webgpu';
...
${ this.tab }}`;
	...
	emit( ast ) {
		...
		let header = '// 4.js Transpiler r' + REVISION + '\n\n';
		let footer = '';
