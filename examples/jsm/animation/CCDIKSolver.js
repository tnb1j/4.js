 ...
 *
 * @four_import import { CCDIKSolver } from '@tnb1j/4js/addons/animation/CCDIKSolver.js';
 */
class CCDIKSolver {
		...
		for ( let i = 0, il = iks.length; i < il; i ++ ) {
			...
			for ( let j = 0, jl = links.length; j < jl; j ++ ) {
				...
				if ( link0.parent !== link1 ) {
					...
					console.warn( 'FOUR.CCDIKSolver: bone ' + link0.name + ' is not the child of bone ' + link1.name );
 ...
 *
 * @augments Object3D
 * @four_import import { CCDIKHelper } from '@tnb1j/4js/addons/animation/CCDIKSolver.js';
 */
