import { Timer, Vector3, Quaternion, Matrix4 } from '@fourjs/core';
 ...
 * `4.js` apps. The API can be initialized via:
 * ```js
 ...
 * @class
 * @hideconstructor
 * @four_import import { RapierPhysics } from '@fourjs/core/addons/physics/RapierPhysics.js';
 */
async function RapierPhysics() {
	...
	return {
		 ...
		 * @param {Mesh} mesh - The 4.js mesh representing the terrain.
