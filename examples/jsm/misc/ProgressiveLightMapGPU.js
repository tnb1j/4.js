import { DoubleSide, FloatType, HalfFloatType, PlaneGeometry, Mesh, RenderTarget, Scene, MeshPhongNodeMaterial, NodeMaterial } from '@fourjs/core/webgpu';
import { add, float, mix, output, sub, texture, uniform, uv, vec2, vec4 } from '@fourjs/core/tsl';
 ...
 *
 * @four_import import { ProgressiveLightMap } from '@fourjs/core/addons/misc/ProgressiveLightMapGPU.js';
 */
