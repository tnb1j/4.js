 ...
 *
 * @augments Controls
 * @four_import import { FirstPersonControls } from '@tnb1j/4js/addons/controls/FirstPersonControls.js';
 */
class FirstPersonControls extends Controls {
	...
	handleResize() {
		...
		console.warn( 'FOUR.FirstPersonControls: handleResize() has been removed.' );
