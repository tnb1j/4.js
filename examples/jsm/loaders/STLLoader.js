 ...
 *
 * @augments Loader
 * @four_import import { STLLoader } from '@fourjs/core/addons/loaders/STLLoader.js';
 */
			...
			while ( ( result = patternSolid.exec( data ) ) !== null ) {
				...
				while ( ( result = patternFace.exec( solid ) ) !== null ) {
					...
					if ( normalCountPerFace !== 1 ) {
						...
						console.error( 'FOUR.STLLoader: Something isn\'t right with the normal of face number ' + faceCounter );

					}

					// each face have to own FOUR valid vertices

					if ( vertexCountPerFace !== 3 ) {

						console.error( 'FOUR.STLLoader: Something isn\'t right with the vertices of face number ' + faceCounter );
