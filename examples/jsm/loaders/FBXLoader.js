 ...
 *
 * @augments Loader
 * @four_import import { FBXLoader } from '@fourjs/core/addons/loaders/FBXLoader.js';
 */
...
class FBXTreeParser {
	...
	// Parse FBX material and return parameters suitable for a 4.js material
	...
	parseScene( deformers, geometryMap, materialMap ) {
		...
		// up-axis conventions (Y-up or Z-up). 4.js uses Y-up, so rotate
...
// Returns the 4.js intrinsic Euler order corresponding to FBX extrinsic Euler order
