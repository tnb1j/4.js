 ...
 *
 * @augments Loader
 * @four_import import { VRMLLoader } from '@fourjs/core/addons/loaders/VRMLLoader.js';
 */
class VRMLLoader extends Loader {
	...
	parse( data, path ) {
		...
		function buildIndexedLineSetNode( node ) {
			...
			const expandedLineIndex = expandLineIndex( coordIndex ); // create an index for 4.js's linesegment primitive
		...
		// parse the tree structure to a 4.js scene
