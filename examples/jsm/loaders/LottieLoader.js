 ...
 *
 * @augments Loader
 * @four_import import { LottieLoader } from '@fourjs/core/addons/loaders/LottieLoader.js';
 */
class LottieLoader extends Loader {
	...
	constructor( manager ) {
		...
		console.warn( 'FOUR.LottieLoader: The loader has been deprecated and will be removed with r186. Use lottie-web instead and create your animated texture manually.' );
