 ...
 * ```
 *
 * @four_import import { XRControllerModelFactory } from '@fourjs/core/addons/webxr/XRControllerModelFactory.js';
 */
			...
			fetchProfile( xrInputSource, this.path, DEFAULT_PROFILE ).then( ( { profile, assetPath } ) => {
				...
				if ( cachedAsset ) {
					...
					if ( ! this.gltfLoader ) {
						...
						throw new Error( 'FOUR.XRControllerModelFactory: GLTFLoader not set.' );
					...
					() => {
						...
						throw new Error( `FOUR.XRControllerModelFactory: Asset ${controllerModel.motionController.assetUrl} missing or malformed.` );
