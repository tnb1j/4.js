...
import { Loop, NodeUpdateType, getDistanceAttenuation, positionView, renderGroup, smoothstep, uniform, uniformArray, vec3 } from '@tnb1j/4js/tsl';
...
const warn = ( message ) => {
	...
	console.warn( `FOUR.SpotLightDataNode: ${ message }` );
