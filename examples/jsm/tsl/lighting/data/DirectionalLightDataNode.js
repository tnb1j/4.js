import { Color, Node, Vector3 } from '@fourjs/core/webgpu';
import { Loop, NodeUpdateType, renderGroup, uniform, uniformArray, vec3 } from '@fourjs/core/tsl';
...
const warn = ( message ) => {
	...
	console.warn( `FOUR.DirectionalLightDataNode: ${ message }` );
