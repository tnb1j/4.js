import { HalfFloatType, RenderTarget, Vector2, Vector3, TempNode, QuadMesh, NodeMaterial, RendererUtils, NodeUpdateType } from '@tnb1j/4js/webgpu';
import { nodeObject, Fn, float, uv, passTexture, uniform, Loop, texture, luminance, smoothstep, mix, vec4, uniformArray, add, int } from '@tnb1j/4js/tsl';
 ...
 * ```
 * @augments TempNode
 * @four_import import { bloom } from '@tnb1j/4js/addons/tsl/display/BloomNode.js';
 */
