import { HalfFloatType, LinearFilter, NearestFilter, RenderTarget, Texture, Vector2, QuadMesh, NodeMaterial, TempNode, RendererUtils } from '@fourjs/core/webgpu';
import { abs, Fn, NodeUpdateType, uv, uniform, convertToTexture, varyingProperty, vec2, vec4, modelViewProjection, passTexture, max, step, dot, float, texture, If, Loop, int, Break, sqrt, sign, mix } from '@fourjs/core/tsl';
 ...
 *
 * @augments TempNode
 * @four_import import { smaa } from '@fourjs/core/addons/tsl/display/SMAANode.js';
 */
