import { RenderTarget, Vector2, NodeMaterial, RendererUtils, QuadMesh, TempNode, NodeUpdateType } from '@tnb1j/4js/webgpu';
import { Fn, float, uv, uniform, convertToTexture, vec2, vec4, passTexture, premultiplyAlpha, unpremultiplyAlpha } from '@tnb1j/4js/tsl';
 ...
 *
 * @augments TempNode
 * @four_import import { gaussianBlur, premultipliedGaussianBlur } from '@tnb1j/4js/addons/tsl/display/GaussianBlurNode.js';
 */
class GaussianBlurNode extends TempNode {
	...
	get resolution() {
		...
		console.warn( 'FOUR.GaussianBlurNode: The "resolution" property has been renamed to "resolutionScale" and is now of type `number`.' ); // @deprecated r180
...
export function premultipliedGaussianBlur( node, directionNode, sigma ) {
	...
	console.warn( 'FOUR.TSL: "premultipliedGaussianBlur()" is deprecated. Use "gaussianBlur()" with "premultipliedAlpha: true" option instead.' ); // deprecated, r180
