import { HalfFloatType, RenderTarget, Vector2, NodeMaterial, RendererUtils, QuadMesh, TempNode, NodeUpdateType } from '@fourjs/core/webgpu';
import { Fn, float, vec2, vec3, vec4, ivec2, int, uv, floor, fract, abs, max, min, clamp, saturate, sqrt, select, exp2, nodeObject, passTexture, textureSize, textureLoad, convertToTexture } from '@fourjs/core/tsl';
 ...
 *
 * @augments TempNode
 * @four_import import { fsr1 } from '@fourjs/core/addons/tsl/display/fsr1/FSR1Node.js';
 */
