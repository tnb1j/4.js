import { NearestFilter, Vector4, TempNode, NodeUpdateType, PassNode } from '@fourjs/core/webgpu';
import { nodeObject, Fn, float, uv, uniform, convertToTexture, vec2, vec3, clamp, floor, dot, smoothstep, If, sign, step, mrt, output, normalView, property, vec4 } from '@fourjs/core/tsl';
 ...
 *
 * @augments PassNode
 * @four_import import { pixelationPass } from '@fourjs/core/addons/tsl/display/PixelationPassNode.js';
 */
