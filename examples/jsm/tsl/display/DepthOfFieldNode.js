import { TempNode, NodeMaterial, NodeUpdateType, RenderTarget, Vector2, HalfFloatType, RedFormat, QuadMesh, RendererUtils } from '@fourjs/core/webgpu';
import { convertToTexture, nodeObject, Fn, uniform, smoothstep, step, texture, max, uniformArray, outputStruct, property, vec4, vec3, uv, Loop, min, mix, float } from '@fourjs/core/tsl';
 ...
 *
 * @augments TempNode
 * @four_import import { dof } from '@fourjs/core/addons/tsl/display/DepthOfFieldNode.js';
 */
