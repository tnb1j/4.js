...
import { Fn, float, uv, uniform, convertToTexture, vec2, vec4, passTexture, luminance, abs, exp, max } from '@tnb1j/4js/tsl';
 ...
 *
 * @augments TempNode
 * @four_import import { bilateralBlur } from '@tnb1j/4js/addons/tsl/display/BilateralBlurNode.js';
 */
