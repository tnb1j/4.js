...
```js
import { LightProbeGridHelper } from '@fourjs/core/addons/helpers/LightProbeGridHelper.js';
```
...
[examples/jsm/helpers/LightProbeGridHelper.js](../../examples/jsm/helpers/LightProbeGridHelper.js)