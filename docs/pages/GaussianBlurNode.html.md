...
```js
import { gaussianBlur, premultipliedGaussianBlur } from '@tnb1j/4js/addons/tsl/display/GaussianBlurNode.js';
```
...
[examples/jsm/tsl/display/GaussianBlurNode.js](../../examples/jsm/tsl/display/GaussianBlurNode.js)