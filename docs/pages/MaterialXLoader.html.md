...
```js
import { MaterialXLoader } from '@fourjs/core/addons/loaders/MaterialXLoader.js';
```
...
[examples/jsm/loaders/MaterialXLoader.js](../../examples/jsm/loaders/MaterialXLoader.js)