...
```js
import { HDRCubeTextureLoader } from '@tnb1j/4js/addons/loaders/HDRCubeTextureLoader.js';
```
...
[examples/jsm/loaders/HDRCubeTextureLoader.js](../../examples/jsm/loaders/HDRCubeTextureLoader.js)