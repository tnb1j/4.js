...
```js
import { EdgeSplitModifier } from '@tnb1j/4js/addons/modifiers/EdgeSplitModifier.js';
```
...
[examples/jsm/modifiers/EdgeSplitModifier.js](../../examples/jsm/modifiers/EdgeSplitModifier.js)