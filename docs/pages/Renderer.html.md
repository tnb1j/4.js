...
The coordinate system of the renderer. The value of this property depends on the selected backend. Either `FOUR.WebGLCoordinateSystem` or `FOUR.WebGPUCoordinateSystem`.
...
[src/renderers/common/Renderer.js](../../src/renderers/common/Renderer.js)