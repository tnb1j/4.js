...
The current probe implementation in 4.js supports so-called diffuse light probes. This type of light probe is functionally equivalent to an irradiance environment map.
...
[src/lights/LightProbe.js](../../src/lights/LightProbe.js)