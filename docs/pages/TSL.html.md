...
This function blends two color based on their alpha values by replicating the behavior of `FOUR.NormalBlending`. It assumes both input colors have non-premultiplied alpha.
...
The value of this uniform or your type. Usually a JS primitive or 4.js object (vector, matrix, color, texture).
