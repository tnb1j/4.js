...
```js
import { getGroundProjectedNormal } from '@fourjs/core/addons/tsl/utils/GroundedSkybox.js';
```
...
[examples/jsm/tsl/utils/GroundedSkybox.js](../../examples/jsm/tsl/utils/GroundedSkybox.js)