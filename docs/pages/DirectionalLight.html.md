...
A common point of confusion for directional lights is that setting the rotation has no effect. This is because 4.js's DirectionalLight is the equivalent to what is often called a 'Target Direct Light' in other applications.
...
[src/lights/DirectionalLight.js](../../src/lights/DirectionalLight.js)