...
```js
import { dotScreen } from '@fourjs/core/addons/tsl/display/DotScreenNode.js';
```
...
[examples/jsm/tsl/display/DotScreenNode.js](../../examples/jsm/tsl/display/DotScreenNode.js)