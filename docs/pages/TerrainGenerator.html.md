...
Bakes a procedural mountain range into a single FOUR.BufferGeometry and returns a `FOUR.Group` ready to add to a scene.
...
[examples/jsm/generators/TerrainGenerator.js](../../examples/jsm/generators/TerrainGenerator.js)