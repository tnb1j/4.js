...
```js
import { DynamicLightsNode } from '@fourjs/core/addons/tsl/lighting/DynamicLightsNode.js';
```
...
[examples/jsm/tsl/lighting/DynamicLightsNode.js](../../examples/jsm/tsl/lighting/DynamicLightsNode.js)