...
```js
import { LightProbeGenerator } from '@fourjs/core/addons/lights/LightProbeGenerator.js';
```
...
[examples/jsm/lights/LightProbeGenerator.js](../../examples/jsm/lights/LightProbeGenerator.js)